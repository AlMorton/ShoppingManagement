...
var FetchData = /** @class */ (function (_super) {
    ...
    FetchData.renderForecastsTable = function (forecasts) {
        return className = 'table table-striped';
        aria - labelledby;
        "tabelLabel" >
            Date < /th>
            < th > Temp.(C) < /th>
            ...
            { forecasts: forecasts, : .map(function (forecast) {
                    ...
                    { forecast: forecast, : .date } < /td>
                    < td > { forecast: forecast, : .temperatureC } < /td>
                    < td > { forecast: forecast, : .temperatureF } < /td>
                    < td > { forecast: forecast, : .summary } < /td>
                    < /tr>) }
            < /tbody>
            < /table>;
        ;
